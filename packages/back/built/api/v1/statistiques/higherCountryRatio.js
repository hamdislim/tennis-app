...
const higherCountryRatio_1 = __importDefault(require("../../../controllers/statistiques/higherCountryRatio"));
const customError_1 = __importDefault(require("../../../dtos/customError"));
const higherCountryRatio = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
